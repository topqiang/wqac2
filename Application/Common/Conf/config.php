...
return  array(
    ...
    'MODULE_ALLOW_LIST'     => array('Home','Admin','Wpi','Api'), //分组
    ...
    'COOKIE_PREFIX'         => 'TXUNDA', // Cookie前缀 避免冲突
    ...
    'SESSION_PREFIX'        => 'TXUNDA', // session 前缀
    ...
    //扩展配置
    'LOAD_EXT_CONFIG'       => 'regular,verify,socialize,database,other',
    'LOAD_EXT_FILE'         => 'Upload',

    //api路径
    'API_URL'               => 'http://localhost/AdminTest',
    'THUMB_PREFIX'          => 'thumb_',
