...
* 需求类别数据模型
*/
class ContactLogModel extends Model{
	//protected $tableName = 'ContactLog';
	/**
     * 查询多条数据
     * @param array $where
     * @param string $order
     ...
     * @return array
     */
    public function selectContactLog($where = array(),$order = '',$page_size = '',$parameter = array()){
     ...
     * 增加数据
     */
	public function addContactLog($data){
        if(empty($data)){
            return false;
        }
