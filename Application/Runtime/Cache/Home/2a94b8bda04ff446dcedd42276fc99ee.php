...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">仪表板</h1>
      <ol class="breadcrumb">
        <li class="active">快速查看项目各项运营指标</li>
    </ol>
...
<div class="container-widget">
  ...
  <ul class="topstats clearfix">
    ...
    <li class="col-xs-6 col-lg-2">
      <span class="title"><i class="fa fa-dot-circle-o"></i> 今日收入</span>
      <h3>$36.45</h3>
      <span class="diff"><b class="color-down"><i class="fa fa-caret-down"></i> 26%</b> 相比昨天</span>
    </li>
    <li class="col-xs-6 col-lg-2">
      <span class="title"><i class="fa fa-calendar-o"></i> 本周收入</span>
      <h3>$96.25</h3>
      <span class="diff"><b class="color-up"><i class="fa fa-caret-up"></i> 26%</b> 相比上周</span>
    </li>
    <li class="col-xs-6 col-lg-2">
        ...
        <ul class="mailbox-inbox">
            ...
            <li>
              <a href="#" class="item clearfix">
                <img src="/wqac2.0/Public/Home/img/profileimg.png" alt="img" class="img">
            ...
            <li>
              <a href="#" class="item clearfix">
                <img src="/wqac2.0/Public/Home/img/profileimg2.png" alt="img" class="img">
            ...
            <li>
              <a href="#" class="item clearfix">
                <img src="/wqac2.0/Public/Home/img/profileimg3.png" alt="img" class="img">
            ...
            <li>
              <a href="#" class="item clearfix">
                <img src="/wqac2.0/Public/Home/img/profileimg4.png" alt="img" class="img">
