...
<div class="container-default">
	<div class="row ovhid padding-t-20 margin-b-20" style="display: flex;justify-content: space-between;">
		<div class="disib float-l project posre f-size-20">
			...
			<span class="posab disib text-center p_tj"><i class="fa fa-bar-chart color8" title="统计图"></i></span>
		...
		<div class="disib float-l project posre f-size-20">
			...
			<span class="posab disib text-center p_rz"><a href="loglis.html"><i class="fa fa-edit color5" title="日志"></i></a></span>
			<span class="posab disib text-center p_xq"><i class="fa fa-eye color9" title="详情"></i></span>
			<a href="probug.html"><i class="badge posab">9</i></a>
		</div>
		<div class="disib float-l project posre f-size-20">
			<img src="/wqac2.0/Public/Home/img/example1.jpg"/>
			...
			<span class="posab disib text-center p_rz"><a href="loglis.html"><i class="fa fa-edit color5" title="日志"></i></a></span>
			<span class="posab disib text-center p_xq"><i class="fa fa-eye color9" title="详情"></i></span>
			<a href="probug.html"><i class="badge posab">5</i></a>
		</div>
		<div class="disib float-l project posre f-size-20">
			<img src="/wqac2.0/Public/Home/img/example1.jpg"/>
			...
			<span class="posab disib text-center p_rz"><a href="loglis.html"><i class="fa fa-edit color5" title="日志"></i></a></span>
			<span class="posab disib text-center p_xq"><i class="fa fa-eye color9" title="详情"></i></span>
			<a href="probug.html"><i class="badge posab">4</i></a>
		</div>
		<div class="disib float-l project posre f-size-20">
			<img src="/wqac2.0/Public/Home/img/example1.jpg"/>
			...
			<span class="posab disib text-center p_rz"><a href="loglis.html"><i class="fa fa-edit color5" title="日志"></i></a></span>
			<span class="posab disib text-center p_xq"><i class="fa fa-eye color9" title="详情"></i></span>
			<a href="probug.html"><i class="badge posab">1</i></a>
		</div>
		<div class="disib float-l project posre f-size-20">
			<img src="/wqac2.0/Public/Home/img/example1.jpg"/>
...
<div class="dis-n addpro">
	...
	<div class="ovhid">
		...
		<div class="col-sm-9 pjsection">
			<input type="checkbox" name="pjsection" value="0" checked="checked"/><span>ios</span>
			<input type="checkbox" name="pjsection" value="1"/><span>安卓</span>
			<input type="checkbox" name="pjsection" value="2"/><span>PC网站</span>
			<input type="checkbox" name="pjsection" value="3"/><span>Wap网站</span>
			<input type="checkbox" name="pjsection" value="4"/><span>公众平台</span>
		</div>
	</div>
	<div class="ovhid">
		<label class="col-sm-3">项目类别</label>
		<div class="col-sm-9">
			<select class="form-control pjtype">
...
<div class="padding-20 dis-n xq_form4 xq_form">
	<div class="dragimg">
		...
		<div class="col-sm-9 margin-b-10" style="min-height: 150px;border: 1px solid #BDC4C9;" xq_drop="true">
	...
	<div class="">
		...
		<div class="col-sm-9 jxlevl">
			<input type="radio" name="jxlevl" value="0" checked/><span>功能明细确认中</span>
			<input type="radio" name="jxlevl" value="1"/><span>UI进行中</span>
			<input type="radio" name="jxlevl" value="2"/><span>UI修改中</span>
			<input type="radio" name="jxlevl" value="3"/><span>布局进行中</span>
			<input type="radio" name="jxlevl" value="4"/><span>布局修改中</span>
			<input type="radio" name="jxlevl" value="5"/><span>接口调用中</span>
			<input type="radio" name="jxlevl" value="6"/><span>程序测试中</span>
			<input type="radio" name="jxlevl" value="7"/><span>项目完成</span>
		</div>
	</div>
</div>
	<!---->
