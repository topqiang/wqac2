...
<div class="content">
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      <span class="icon color5-bg"><i class="fa fa-diamond"></i></span>
      <h1>Widgets</h1>
      <h4>Customize your theme with awesome widgets.</h4>
    </div>

    <div class="col-lg-4 col-md-6">
      <ul class="list-unstyled list">
        <li><i class="fa fa-check"></i>All Responsive<li>
...
<div class="container-padding">
  ...
  <div class="row">
    <div class="col-md-12">
    <h4>Top Stats</h4>
    <p>Show your important stats with top stats.</p>
      ...
      <h4>Profile Widget</h4>
        <!-- Start Profile Widget -->
          <div class="widget profile-widget" style="height:380px;">
            <img src="/wqac2.0/Public/Home/img/profileimg.png" class="profile-image" alt="img">
            <h1>Jonathan Doe</h1>
          ...
          <div class="panel widget panel-widget">
            ...
            <div class="panel-body">
              <ul class="basic-list image-list">
                <li><img src="/wqac2.0/Public/Home/img/profileimg.png" alt="img" class="img"><b>Jonathan Doe</b><span class="desc">Designer</span></li>
                <li><img src="/wqac2.0/Public/Home/img/profileimg2.png" alt="img" class="img"><b>Egemem Ka</b><span class="desc">Front-End Developer</span></li>
                <li><img src="/wqac2.0/Public/Home/img/profileimg3.png" alt="img" class="img"><b>Timmy Jefsin</b><span class="desc">Back-End Developer</span></li>
                <li><img src="/wqac2.0/Public/Home/img/profileimg4.png" alt="img" class="img"><b>James K. Throwing</b><span class="desc">Marketing</span></li>
                <li><img src="/wqac2.0/Public/Home/img/profileimg5.png" alt="img" class="img"><b>John Doe</b><span class="desc">iOS Developer</span></li>
              </ul>
            </div>
          </div>
        <!-- End Teammates -->
          ...
          <div class="panel panel-widget blog-post">
            <div class="panel-body">
              ...
              <div class="image-div color10-bg">
                <img src="/wqac2.0/Public/Home/img/example1.jpg" class="image" alt="img">
              ...
              <a href="#">Read More</a>
              <p class="author">
                <img src="/wqac2.0/Public/Home/img/profileimg.png" alt="img">
...
Bootstrap Toggle
================================================ -->
<script type="text/javascript" src="/wqac2.0/Public/Home/js/bootstrap-toggle/bootstrap-toggle.min.js"></script>

<!-- ================================================
Bootstrap WYSIHTML5
================================================ -->
<!-- main file -->
<script type="text/javascript" src="/wqac2.0/Public/Home/js/bootstrap-wysihtml5/wysihtml5-0.3.0.min.js"></script>
<!-- bootstrap file -->
<script type="text/javascript" src="/wqac2.0/Public/Home/js/bootstrap-wysihtml5/bootstrap-wysihtml5.js"></script>

<!-- ================================================
Summernote
================================================ -->
<script type="text/javascript" src="/wqac2.0/Public/Home/js/summernote/summernote.min.js"></script>
...
Data Tables
================================================ -->
<script src="/wqac2.0/Public/Home/js/datatables/datatables.min.js"></script>
