  ...
  <div class="page-header">
    <h1 class="title">Text Editors</h1>
      <ol class="breadcrumb">
        ...
        <li class="active">Text Editors</li>
      </ol>
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-4 col-md-6">
      <ul class="list-unstyled list">
        ...
        <li><i class="fa fa-check"></i><a href="http://jhollingworth.github.io/bootstrap-wysihtml5/" target="_blank">Bootstrap-wysihtml5</a><li>
        <li><i class="fa fa-check"></i><a href="http://summernote.org/" target="_blank">Summernote</a><li>
      </ul>
    </div>
